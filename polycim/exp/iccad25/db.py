...
class DataBase:
    ...
    def insert_experiment_result(self, exp_result: ExperimentResult) -> int:
        ...
        self.cursor.execute(
            ...
            (exp_result.experiment_id, exp_result.op, exp_result.strategy, exp_result.status, exp_result.save_path, exp_result.macro_ultilization, exp_result.macro_compute_times, exp_result.flops, exp_result.need_minimize_macros, exp_result.latency, exp_result.energy, exp_result.config, exp_result.time)
        )
    ...
    def get_experiment_results_by_experiment_id(self, experiment_id: int) -> list[ExperimentResult]:
        self.cursor.execute('SELECT * FROM exp_result WHERE experiment_id = ?', (experiment_id,))
        rows = self.cursor.fetchall()
